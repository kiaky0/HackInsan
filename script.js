...
function checkEndCondition() {
    if (player.col === maze.cols - 1 && player.row === maze.rows - 1) {
        window.alert("Congratulations! You have reached the end of the maze.");
    }
}
...
function onLoad() {
    ...
    player = new Player();
    maze = new Maze(5, 5, 50); // Default to 5x5 maze
